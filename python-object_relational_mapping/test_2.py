"""
Checker script to test the implementation of 2-my_filter_states.py.
...
def run_pylint():
    """Run pylint on the 2-my_filter_states.py file and print the output."""
    command = ["pylint", "2-my_filter_states.py"]
...
def run_mypy():
    """Run mypy on the 2-my_filter_states.py file and print the output."""
    command = ["mypy", "2-my_filter_states.py"]
    stdout, stderr, returncode = run_command(command)
...
def run_flake8():
    """Run flake8 on the 2-my_filter_states.py file and print the output."""
    command = ["flake8", "--config=.flake8", "2-my_filter_states.py"]
    stdout, stderr, returncode = run_command(command)
...
def run_black():
    """Run black on the 2-my_filter_states.py file and print the output."""
    command = ["black", "--check", "2-my_filter_states.py"]
    stdout, stderr, returncode = run_command(command)
...
def run_isort():
    """Run isort on the 2-my_filter_states.py file and print the output."""
    command = ["isort", "--check-only", "2-my_filter_states.py"]
    stdout, stderr, returncode = run_command(command)
...
class TestOutput(unittest.TestCase):
    def test_output(self):
        ...
        command = ["./2-my_filter_states.py", "root", "sgc91", "hbtn_0e_0_usa", "Arizona"]
...
if __name__ == "__main__":
    ...
    if pylint_returncode == 0 or pylint_returncode == 2:  # Allow filename warning
        ...
        print(Fore.RED + "Pylint check: Failed. Run: $ pylint 2-my_filter_states.py" + Style.RESET_ALL)

    mypy_returncode = run_mypy()
    if mypy_returncode == 0:
        print(Fore.GREEN + "Mypy check: Passed" + Style.RESET_ALL)
    else:
        print(Fore.RED + "Mypy check: Failed. Run: $ mypy 2-my_filter_states.py" + Style.RESET_ALL)

    flake8_returncode = run_flake8()
    if flake8_returncode == 0:
        print(Fore.GREEN + "Flake8 check: Passed" + Style.RESET_ALL)
    else:
        print(Fore.RED + "Flake8 check: Failed. Run: $ flake8 --config=.flake8 2-my_filter_states.py" + Style.RESET_ALL)

    black_returncode = run_black()
    if black_returncode == 0:
        print(Fore.GREEN + "Black check: Passed" + Style.RESET_ALL)
    else:
        print(Fore.RED + "Black check: Failed. Run: $ black 2-my_filter_states.py" + Style.RESET_ALL)

    isort_returncode = run_isort()
    if isort_returncode == 0:
        print(Fore.GREEN + "isort check: Passed" + Style.RESET_ALL)
    else:
        print(Fore.RED + "isort check: Failed. Run: $ isort 2-my_filter_states.py" + Style.RESET_ALL)
